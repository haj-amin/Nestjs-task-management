    ...
    getTasks(filterDto, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.logger.verbose(`Failed to get tasks for user ${user.username}. Filter: ${JSON.stringify(filterDto)}`, error.stack);
    ...
    createTask(createTaskDto, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this.logger.verbose(`Failed to create a task for user ${user.username}. Data: ${JSON.stringify(createTaskDto)}`, error.stack);
                throw new common_1.InternalServerErrorException();
            }
            delete task.user;
            return task;
